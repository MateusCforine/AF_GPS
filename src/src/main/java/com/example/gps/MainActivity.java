...
public class MainActivity extends AppCompatActivity {
    ...
    private static final double LATITUDE_SOROCABA = -23.5015;
    private static final double LONGITUDE_SOROCABA = -47.4526;
    ...
    private void obterLocalizacaoAtual() {
        try {
            ...
            if (location != null) {
                ...
                Toast.makeText(
                        this,
                        "GPS não localizado. Usando Sorocaba/SP como padrão.",
                        Toast.LENGTH_LONG
                ).show();
            }
            ...
            Toast.makeText(
                    this,
                    "Erro ao capturar localização. Usando Sorocaba/SP.",
                    Toast.LENGTH_LONG
            ).show();
        }
    }

    private void usarLocalizacaoSorocaba() {
        latitudeAtual = LATITUDE_SOROCABA;
        longitudeAtual = LONGITUDE_SOROCABA;
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (requestCode == CODIGO_PERMISSAO_LOCALIZACAO) {
            if (grantResults.length > 0 &&
                ...
                Toast.makeText(
                        this,
                        "Sem permissão, será usada a localização padrão de Sorocaba/SP.",
                        Toast.LENGTH_LONG
                ).show();
